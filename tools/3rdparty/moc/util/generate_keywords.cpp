...
static const Keyword keywords[] = {
    ...
    { "QAS_JSON_TYPE_SERIALIZER", "QAS_JSON_TYPE_SERIALIZER_TOKEN" },
    { "QAS_JSON_TYPE_DESERIALIZER", "QAS_JSON_TYPE_DESERIALIZER_TOKEN" },
    { "QAS_JSON_PROPERTY", "QAS_JSON_PROPERTY_TOKEN" },
    { "QAS_JSON_IGNORE", "QAS_JSON_IGNORE_TOKEN" },
    { "QAS_ENUM_TYPE_SERIALIZER", "QAS_ENUM_TYPE_SERIALIZER_TOKEN" },
    { "QAS_ENUM_TYPE_DESERIALIZER", "QAS_ENUM_TYPE_DESERIALIZER_TOKEN" },
    { "QAS_ENUM_PROPERTY", "QAS_ENUM_PROPERTY_TOKEN" },
    { "QAS_ENUM_IGNORE", "QAS_ENUM_IGNORE_TOKEN" },
    /* Add QAS macros end */
    { "\n", "NEWLINE" },
    { "\"", "QUOTE" },
    { "\'", "SINGLEQUOTE" },
